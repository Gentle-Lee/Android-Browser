...
/**
 * Created by Tommy on 2017/5/17.
 */

public class ThreadDownloader extends Thread {

    private static final String TAG = ThreadDownloader.class.getSimpleName();
    ...
    public ThreadDownloader(URL downloadUrl, File file, int blocksize, int threadId){
