...
public class BrowserDBHelper extends SQLiteOpenHelper {
    ...
    private final String[] TABLE_NAME = {"BOOKMARK_DB","HISTORY_DB"};
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String bookmarkSql = "create table if not exists " + TABLE_NAME[1] + " (Id integer primary key,BookmarkName text,BookmarkUrl text)";
        String historySql = "create table if not exists " + TABLE_NAME[2] + " (Id integer primary key, HistoryName text,HistoryUrl text)";
